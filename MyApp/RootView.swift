...
//        let authenticationViewModel = AuthenticationOptionsViewModel(authManager: viewModel.authManager)
//        return AuthenticationView(viewModel: authenticationViewModel)
//    }
//    
